...
var HashTagLoad = function() {navigator.notification.prompt(
...
$(document).ready(function() {
	...
	for (i=0; i<24; i++)	{
		...
		if (i==12) {
			$('#board').append("<div data-value='1' class='selected freesquare' id='sqfree'><p class='text noselect'><br/>free space</p></div>");
			$('#board').append("<div data-value='0' class='square' id='sq12'><p class='text noselect'><br/>"+JSONBingo.squares[i].square+"</p></div>");
		} else {
			$('#board').append("<div data-value='0' class='square' id='sq"+i+"'><p class='text noselect'><br/>"+JSONBingo.squares[i].square+"</p></div>");
